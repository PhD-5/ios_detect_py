	...
	<div class="container">
		...
		<div class="mainContent">
			...
			<table class="table table-bordered table-hover" style="width:100%;">
				<tr><th>序号</th><th>应用名</th><th>下发任务时间</th><th>状态</th><th>检测报告</th><th>操作</th></tr>
...
EOF;
				...
				while ($row = $ret->fetchArray(SQLITE3_ASSOC)) {
					...
					if (isset($detect_flag[$j])) {
						...
						echo "<td><button class='btn btn-default'><a href='downloadreport.php?name=" . $row['NAME'] . "&path=" . $row['REPORTPATH'] . "'>下载</a></button></td>";
					}
					else{
						echo "<td>未生成</td>";
					}
					echo "<td><button class='btn btn-default'><a href='delete_task.php?id=" . $row['APPID'] . "'>删除</a></button></td>";
					$j++;
				}
